...
import 'package:flutter_downloader_example/etec/papers/papersetec.dart';
import 'package:flutter_downloader_example/etec/shortnote/etecshorthome.dart';
import 'package:flutter_downloader_example/etec/textbook/Etectxtbook.dart';
...
import 'marking/etecmarking.dart';

class Etechome extends StatefulWidget {
  const Etechome({Key? key}) : super(key: key);

  @override
  _EtechomeState createState() => _EtechomeState();
}

class _EtechomeState extends State<Etechome> {
  @override
